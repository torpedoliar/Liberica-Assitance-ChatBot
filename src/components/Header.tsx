...
import { History, Coffee, Wrench, Lightbulb, TrendingUp, Sparkles, Info } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  showSidebar, setShowSidebar, currentMode, setCurrentMode, setShowInfoModal, sessionUser, handleLogin
}) => {
  return (
